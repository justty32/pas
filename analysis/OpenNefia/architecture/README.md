...
| 文件 | 內容 |
|------|------|
| [01_project_overview.md](01_project_overview.md) | 專案整體結構、技術棧、設計哲學（核對 2026-06-01） |
...
| [08_ui_system.md](08_ui_system.md) | 使用者介面系統（舊版 UiElement） |
...
| [14_xaml_wisp_ui.md](14_xaml_wisp_ui.md) | XAML 編譯期 IL 注入 + Wisp 自動版面配置 UI 框架（新增 2026-06-01） |
...
4. XAML / Wisp UI（開發中的新 UI 系統）
   → XamlX 技術在編譯期將 .xaml 轉換為 IL
   → WispControl 提供 Measure/Arrange 自動版面
   → 目前僅用於除錯視窗，未來計畫取代舊版 UiElement
```
